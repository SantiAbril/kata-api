# language:es
  ...
  Característica: Actualización de carritos en la API
    ...
    Escenario: Actualizacion de carrito existente
      Cuando realiza un consumo PUT al recurso correspondiente con los datos del carrito
    ...
    Escenario: Actualización fallida de carrito con solicitud incorrecta
      Cuando realiza un consumo PUT al recurso correspondiente con parametros incorrectos
